          ...
          <div className="row align-items-center">
            ...
            <div className="col-6">
              ...
              <p className="text-dark">
                Kelas di Otodyduck <strong>100% dilakukan secara online</strong>{" "}
                (tidak ada pertemuan di tempat selama masa belajar) dan{" "}
                <strong>video pembelajarannya dapat diunduh</strong> untuk
                dipelajari secara offline (tanpa menggunakan koneksi Internet).
              </p>
            </div>
          </div>
        </div>
